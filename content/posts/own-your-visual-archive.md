...
1. Export using methods from [our Pinterest guide](/posts/export-pinterest-boards-guide/)
2. Tag and organize during import
3. Apply consistent naming conventions
4. Set up auto-backup before adding new references
...
**Weekly:** New references → local backup
**Monthly:** Full archive → external drive
