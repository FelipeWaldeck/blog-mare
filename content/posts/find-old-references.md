...
**Bad tags:** "photography, print, digital, illustration" (category-based)
**Good tags:** "skin-tones, headers, color-palettes, mood-boards" (use-based)
...
1. **Today:** Review your reference library using C.R.E.A.M. for any references you've been unable to find
2. **This week:** Add retrieval-oriented tags to your references—focus on use-based rather than category-based tags
3. **This month:** Implement weekly review habit to keep your library fresh in memory
