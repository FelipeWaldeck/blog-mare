...
**Cons:** No visual search, fragmented
...
**How many tags should each item have?**
3-7 tags. Enough to be findable, not so many it becomes noise.

**Should I delete old references?**
Yes. If you haven't looked at it in 6 months and don't remember it, archive or delete.

**What's the difference between tagging and folders?**
Folders = one home per item. Tags = item can live everywhere.
